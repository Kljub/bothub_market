...
$commands = [
    "$pk:globalchat-link"   => ['cmd' => '/globalchat-link',   'label' => bh_plugin_t($pk, 'link.label'),   'desc' => bh_plugin_t($pk, 'link.desc'),   'defaultPerms' => ['ManageGuild']],
    "$pk:globalchat-unlink" => ['cmd' => '/globalchat-unlink', 'label' => bh_plugin_t($pk, 'unlink.label'), 'desc' => bh_plugin_t($pk, 'unlink.desc'), 'defaultPerms' => ['ManageGuild']],
];
