...
<div class="bh-module-row"><div style="display:flex;align-items:center;gap:12px;padding:10px 16px;flex:1;min-width:0;">
  ...
  $pk = 'weather-plugin';
  $cmdHeading = [
      'code' => '/weather [ort]', 'key' => 'weather-plugin-weather', 'label' => bh_plugin_t($pk, 'weather.label'),
      'desc' => bh_plugin_t($pk, 'weather.desc'),
      'label_color' => $enabled ? 'var(--text-primary)' : 'var(--text-muted)',
  ];
  require BH_ROOT . '/assets/features/command-heading.php';
  ?>
  <button class="bh-perm-btn <?= $hasPerms ? 'has-perms' : '' ?>" title="<?= __e('cmd.permissions') ?>" onclick="bhTogglePerms('perm-weather-plugin-weather')">
