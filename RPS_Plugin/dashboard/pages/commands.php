...
$pk = 'rps-plugin';
$commands = [
    "$pk:rps"      => ['cmd' => '/rps',      'label' => bh_plugin_t($pk, 'rps.label'),      'desc' => bh_plugin_t($pk, 'rps.desc'),      'defaultPerms' => []],
    "$pk:rps-duel" => ['cmd' => '/rps-duel', 'label' => bh_plugin_t($pk, 'rps_duel.label'), 'desc' => bh_plugin_t($pk, 'rps_duel.desc'), 'defaultPerms' => []],
];
